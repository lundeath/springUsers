...
public class DeleteFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (cookies != null) {
            ...
            if (role != null && role.equals("user")) {   //checking user roots
                System.out.println("Unauthorized access request to Delete feature");
                res.sendRedirect(req.getContextPath() + "/users");

            } else if (role != null && role.equals("superuser")) {
                System.out.println("Unauthorized access request to Delete feature");
                res.sendRedirect(req.getContextPath() + "/users");
            } else {
